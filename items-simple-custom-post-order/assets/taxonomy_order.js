jQuery( document ).ready( function( $ )
{
	...
	if( adminpage == 'edit-tags-php' )
	{
		...
		$( '.wp-list-table.tags tbody' ).sortable({
			...
			stop: function( event, ui ) {
				...
				items_hsam_taxonomy_sort_activity_spinner( true );
				...
				$.post( ajaxurl, { 'rows' : rows, 'action' : 'get_inline_boxes' }, function(response) {
					...
					items_hsam_taxonomy_sort_activity_spinner( false );
				});
			}
		});
	}
	 ...
	 */
	function items_hsam_taxonomy_sort_activity_spinner( status ) {
